...
class Write():
    ...
    def open_files(self):
        ...
        self.out_state_0 = open('Output{}out_state_0.bin'.format(self.fname), mode=self.mode)
        ...
        self.out_state_3 = open('Output{}out_state_3.bin'.format(self.fname), mode=self.mode)
        self.out_state_4 = open('Output{}out_state_4.bin'.format(self.fname), mode=self.mode)
        self.out_state_5 = open('Output{}out_state_5.bin'.format(self.fname), mode=self.mode)
        self.out_state_6 = open('Output{}out_state_6.bin'.format(self.fname), mode=self.mode)
        self.out_state_7 = open('Output{}out_state_7.bin'.format(self.fname), mode=self.mode)
        self.out_state_8 = open('Output{}out_state_8.bin'.format(self.fname), mode=self.mode)
        self.out_state_9 = open('Output{}out_state_9.bin'.format(self.fname), mode=self.mode)
        self.out_state_10 = open('Output{}out_state_10.bin'.format(self.fname), mode=self.mode)
        self.out_state_11 = open('Output{}out_state_11.bin'.format(self.fname), mode=self.mode)
        if self.k_size >= 13:
            self.out_state_12 = open('Output{}out_state_12.bin'.format(self.fname), mode=self.mode)
        if self.k_size >= 14:
            self.out_state_13 = open('Output{}out_state_13.bin'.format(self.fname), mode=self.mode)
        if self.k_size >= 15:
            self.out_state_14 = open('Output{}out_state_14.bin'.format(self.fname), mode=self.mode)
        ...
        self.out_state0_station = open('Output{}out_state0_station.bin'.format(self.fname), mode=self.mode)
        ...
        self.out_state3_station = open('Output{}out_state3_station.bin'.format(self.fname), mode=self.mode)
        self.out_state4_station = open('Output{}out_state4_station.bin'.format(self.fname), mode=self.mode)
        self.out_state5_station = open('Output{}out_state5_station.bin'.format(self.fname), mode=self.mode)
        self.out_state6_station = open('Output{}out_state6_station.bin'.format(self.fname), mode=self.mode)
        self.out_state7_station = open('Output{}out_state7_station.bin'.format(self.fname), mode=self.mode)
        self.out_state8_station = open('Output{}out_state8_station.bin'.format(self.fname), mode=self.mode)
        self.out_state9_station = open('Output{}out_state9_station.bin'.format(self.fname), mode=self.mode)
        self.out_state10_station = open('Output{}out_state10_station.bin'.format(self.fname), mode=self.mode)
        self.out_state11_station = open('Output{}out_state11_station.bin'.format(self.fname), mode=self.mode)
        if self.k_size >= 13:
            self.out_state12_station = open('Output{}out_state12_station.bin'.format(self.fname), mode=self.mode)
        if self.k_size >= 14:
            self.out_state13_station = open('Output{}out_state13_station.bin'.format(self.fname), mode=self.mode)
        if self.k_size >= 15:
            self.out_state14_station = open('Output{}out_state14_station.bin'.format(self.fname), mode=self.mode)
    ...
    def close_files(self):
        ...
        self.out_V.close()
        self.out_state_0.close()
        self.out_state_1.close()
        self.out_state_2.close()
        self.out_state_3.close()
        self.out_state_4.close()
        self.out_state_5.close()
        self.out_state_6.close()
        self.out_state_7.close()
        self.out_state_8.close()
        self.out_state_9.close()
        self.out_state_10.close()
        self.out_state_11.close()
        if self.k_size >= 13:
            self.out_state_12.close()
        if self.k_size >= 14:
            self.out_state_13.close()
        if self.k_size >= 15:
            self.out_state_14.close()
        self.out_tau.close()
        self.out_Pr.close()
        self.out_Gcd.close()
        self.out_delta_station.close()
        self.out_V_station.close()
        self.out_state0_station.close()
        self.out_state1_station.close()
        self.out_state2_station.close()
        self.out_state3_station.close()
        self.out_state4_station.close()
        self.out_state5_station.close()
        self.out_state6_station.close()
        self.out_state7_station.close()
        self.out_state8_station.close()
        self.out_state9_station.close()
        self.out_state10_station.close()
        self.out_state11_station.close()
        if self.k_size >= 13:
            self.out_state12_station.close()
        if self.k_size >= 14:
            self.out_state13_station.close()
        if self.k_size >= 15:
            self.out_state14_station.close()
    ...
    def write_sparse(self, delta, V,
                    state_0, state_1, state_2, state_3, state_4, state_5,
                    state_6, state_7, state_8, state_9, state_10, state_11,
                    state_12, state_13, state_14, tau):
        self.out_delta.write(delta.tobytes())
        self.out_V.write(V.tobytes())
        self.out_state_0.write(state_0.tobytes())
        self.out_state_1.write(state_1.tobytes())
        self.out_state_2.write(state_2.tobytes())
        self.out_state_3.write(state_3.tobytes())
        self.out_state_4.write(state_4.tobytes())
        self.out_state_5.write(state_5.tobytes())
        self.out_state_6.write(state_6.tobytes())
        self.out_state_7.write(state_7.tobytes())
        self.out_state_8.write(state_8.tobytes())
        self.out_state_9.write(state_9.tobytes())
        self.out_state_10.write(state_10.tobytes())
        self.out_state_11.write(state_11.tobytes())
        if self.k_size >= 13:
            self.out_state_12.write(state_12.tobytes())
        if self.k_size >= 14:
            self.out_state_13.write(state_13.tobytes())
        if self.k_size >= 15:
            self.out_state_14.write(state_14.tobytes())
    ...
    def write_station(self, delta, V,
                      state_0, state_1, state_2, state_3, state_4, state_5,
                      state_6, state_7, state_8, state_9, state_10, state_11,
                      state_12, state_13, state_14, tau):
        self.out_delta_station.write(delta.tobytes())
        self.out_V_station.write(V.tobytes())
        self.out_state0_station.write(state_0.tobytes())
        self.out_state1_station.write(state_1.tobytes())
        self.out_state2_station.write(state_2.tobytes())
        self.out_state3_station.write(state_3.tobytes())
        self.out_state4_station.write(state_4.tobytes())
        self.out_state5_station.write(state_5.tobytes())
        self.out_state6_station.write(state_6.tobytes())
        self.out_state7_station.write(state_7.tobytes())
        self.out_state8_station.write(state_8.tobytes())
        self.out_state9_station.write(state_9.tobytes())
        self.out_state10_station.write(state_10.tobytes())
        self.out_state11_station.write(state_11.tobytes())
        if self.k_size >= 13:
            self.out_state12_station.write(state_12.tobytes())
        if self.k_size >= 14:
            self.out_state13_station.write(state_13.tobytes())
        if self.k_size >= 15:
            self.out_state14_station.write(state_14.tobytes())
